    ...
    <div className="from-primary-gray-200 to-primary-100/30 min-h-screen bg-gradient-to-br via-white">
      <div className="container mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="relative grid gap-16 lg:grid-cols-2">
          ...
          <div>
            <div className="border-primary-200 sticky top-20 rounded-xl border bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-xl">
                      ...
                      >
                        ...
                        <div
                          className={`relative z-10 flex h-14 w-14 items-center justify-center rounded-xl shadow-lg transition-all duration-500 ${
                            isCompleted
                              ? 'from-primary-400 to-primary-500 shadow-primary-200 ring-primary-100 bg-gradient-to-br text-white ring-4'
                              : isCurrent
